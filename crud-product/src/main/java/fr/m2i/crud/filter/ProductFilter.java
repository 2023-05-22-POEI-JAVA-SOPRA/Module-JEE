...
public class ProductFilter extends HttpFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if ( httpRequest.getMethod().equals("POST") && 
			stringExists(httpRequest, response, "name") &&
			stringExists(httpRequest, response, "description") &&
			floatEsists(httpRequest, response, "price") &&
	...
	private boolean intExists(HttpServletRequest httpRequest, ServletResponse response, String string) throws IOException {
